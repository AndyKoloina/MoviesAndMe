...
class FilmDetail extends React.Component {
  ...
  componentDidMount() {
    ...
    getFilmDetailFromApi(this.props.route.params.idFilm).then(data => { /*React navigation version 5 use route instead getParam to get params  */
            this.setState({
                film: data,
                isLoading: false
            })
  ...
  _displayFavoriteImage() {
        var sourceImage = require('../Images/icons8-heart-52.png')
        var shouldEnlarge = false
        if (this.props.favoritesFilm.findIndex(item => item.id === this.state.film.id) !==-1) {
            sourceImage = require('../Images/icons8-heart-50.png')
            shouldEnlarge = true
        }
        return (
