...
class Search extends React.Component {
  ...
  render() {
    return (
      <SafeAreaView style={styles.main_container}>{/*SafeAreView utiliser pour creer un cadre dans lequel notre vue sera placer en dessous des composants du telephone et de la barre de statut */}
